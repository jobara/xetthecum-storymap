...
<button type="button" class="btn btn-secondary btn-rounded" href="#" data-micromodal-trigger="mymodal" tabindex="0">Read the land acknowledgment</button>
...
<button class="close-button" aria-label="Close modal" data-micromodal-close>X</button>
